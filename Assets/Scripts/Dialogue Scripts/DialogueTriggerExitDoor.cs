...
public class DialogueTriggerExitDoor : MonoBehaviour
{
    public Dialogue dialogue;
    public DialogueManagerExitDoor dialogueManager;
    ...
    void TriggerDialogue()
    {
        ...
        DialogueManagerExitDoor.instance.StartDialogue(dialogue);
    }
}
