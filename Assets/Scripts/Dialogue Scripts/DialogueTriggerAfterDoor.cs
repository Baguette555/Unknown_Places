...
public class DialogueTriggerAfterDoor : MonoBehaviour
{
    public Dialogue dialogue;
    public DialogueManagerAfterDoor dialogueManager;
    ...
    void TriggerDialogue()
    {
        ...
        DialogueManagerAfterDoor.instance.StartDialogue(dialogue);
    }
}
