...
public class noAbilitiesControls : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Dash actif. Lancer une anim.");
            // Démarrer animation du dash ?
            // Particules permanantes pour le dash : faire comprendre que les poings / qqch change quand le dash est prêt.
        }
    }
